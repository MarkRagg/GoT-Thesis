...
\end{equation}
where $t_i$ represents the set of tools available.
...
For a better customization of the agent performance, four different LLM configurations are defined for the different agents.
...
\\\\
The Response format contains the final answer and the explanation of it. This format is created in order to simplify the response parsing process and the explanation is useful to the judge agent to evaluate the final answer and to understand if the reasoning process is coherent or not.
\\\\
The Score format is used in the evaluation phase. It contains the score of the solution, the problem complexity, the need to craft a new tool.
\\\\
